...
!function (root, factory) {
	...
	var _data = {
		'':['家己','家自','我'],
		//并称
		'[f|m]':['父母','爹娘','爸妈','双亲','二老','高堂'],
		'[h,f|h,m]':['公婆'],
		'[xb|xs]':['兄弟姐妹'],
		'[s|d]':['孥囝','子女','儿女','囝弟'],
		//本家
		'f':['爸爸','父亲','阿父','阿爸','父上','老爸','爸','父','爹','爹爹','爹地','老爹'],
		'f,f':['祖父','阿公','公','爷爷'],
		'f,f,f':['曾祖父','老祖公'],
		'f,f,f,f':['高祖父','老祖祖公','祖太公'],
		'f,f,f,f,f':['天祖父'],
		'f,f,f,f,f,f':['烈祖父'],
		'f,f,f,f,f,m':['烈祖母'],
		'f,f,f,f,f,f,f':['太祖父'],
		...
		'f,ls':['姑妈','姑姐'],
		//外家
		'm':['妈妈','母亲','老妈','阿妈','老母','老妈子','妈','母','阿母','娘','娘亲','妈咪'],
		'm,f':['外公','外祖父','姥爷'],
		...
		'm,ls,h':['小姨父','小姨丈'],
		//婆家
		'h':['翁','丈夫','先生','官人','男人','汉子','夫','夫君','相公','夫婿','爱人','老伴'],
		'h,f':['公公','翁亲','老公公'],
		'h,f,f':['祖翁'],
		'h,f,f,ob':['伯祖翁'],
		'h,f,f,ob,w':['伯祖婆'],
		...
		'h,xs,s':['姑甥','婆家甥'],
		//岳家
		'w':['妻','老婆','妻子','太太','媳妇儿','媳妇','夫人','女人','内人','娘子','爱人','老伴'],
		...
		'xb,d,d':['外侄孙女','侄外孙女'],
		'xb,d,d,h':['外侄孙女婿'],
		'ob':['兄','阿兄','哥哥','哥','阿哥','大佬','老哥','兄长','胞哥','大哥','x哥'],
		'ob,w':['嫂子','嫂','嫂嫂','阿嫂','兄嫂','大嫂','x嫂'],
		'ob,w,f':['姻伯父'],
		'ob,w,m':['姻伯母'],
		'lb':['弟弟','阿弟','弟','细佬','胞弟','老弟','x弟'],
		...
		's,d,s':['曾外孙'],
		's,d,d':['曾外孙女'],
		'd':['走囝','諸娘囝','女儿','千金','闺女','女','阿女','女女','掌上明珠','乖囡','囡囡','姑娘','x女儿','孩子','孩儿'],
